  ...
  - title: New Opps
    ...
    - table_calculation: goal
      ...
      expression: |-
        ...
        running_total(200) + ${campaign_attribution.ft_campaign_opportunity_count}*0
      value_format:
      value_format_name:
      _kind_hint: measure
      _type_hint: number
  ...
  - title: New Won ACV
    ...
    - table_calculation: goal
      ...
      expression: |-
        ...
        running_total(5000) + ${campaign_attribution.ft_campaign_closed_won_total_acv}*0
      value_format:
      value_format_name:
      _kind_hint: measure
      _type_hint: number
  ...
  - title: New Leads
    ...
    - table_calculation: goal
      ...
      expression: |-
        ...
        running_total(10000) + ${campaign_attribution.ft_all_leads}*0
      value_format:
      value_format_name:
      _kind_hint: measure
      _type_hint: number
